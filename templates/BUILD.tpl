...
cc_toolchain_config(
    ...
    cxx_builtin_include_directories = [
        "/usr/local/include",
        "/usr/local/lib/gcc/x86_64-linux-gnu/",
        "/usr/local/lib/gcc/x86_64-linux-gnu/%{gcc_version}/include",
        "/usr/local/lib/gcc/x86_64-linux-gnu/%{gcc_version}/include-fixed",
        "/usr/lib/gcc/x86_64-pc-linux-gnu/",
        "/usr/include/x86_64-pc-linux-gnu/c++/%{gcc_version}",
        "/usr/lib/gcc/x86_64-pc-linux-gnu/%{gcc_version}/include",
        "/usr/lib/gcc/x86_64-pc-linux-gnu/%{gcc_version}/include-fixed",
